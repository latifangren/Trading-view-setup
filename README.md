...
Detail tiap file ada di [indicator/README.md](indicator/README.md).
...
Untuk pemakaian normal, mulai dari v3. Kalau ingin coba guard lower timeframe dan mode performa yang lebih aman, bandingkan v3 dengan v4 di chart yang sama.
